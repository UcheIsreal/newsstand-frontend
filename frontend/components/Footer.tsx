export default function Footer() {
  ...
  const socials = [
    {
      label: "WhatsApp",
      href: "https://wa.me/2348164277071", // replace with your number e.g. 2348012345678
      icon: (
    ...
    {
      label: "Email",
      href: "mailto:uchejacob99@gmail.com", // replace with your email
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
      label: "Twitter / X",
      href: "https://twitter.com/VidsGoHard", // replace with your handle
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
      label: "LinkedIn",
      href: "https://linkedin.com/in/uche-ogbonna-ab5b41a4/", // replace with your profile URL
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    {
      label: "TikTok",
      href: "https://tiktok.com/@ninojakesully", // replace with your handle
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
